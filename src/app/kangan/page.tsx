...
const kangan = () => {
  ...
  const kanganData = [
    ...
    { id: 11, name: 'Bow style', price: 30000, Description: 'Unique style', image: '/silver 2.jpg' },
        ...
        {kanganData.map((kangan) => (
          <div key={kangan.id} className='kangan-card'>
            <Image 
              src={kangan.image} 
              alt={kangan.name} 
              width={500} // You can adjust width
              height={500} // You can adjust height
              layout="intrinsic" // Optional: if you want to maintain aspect ratio
            />
            <h3>{kangan.name}</h3>
